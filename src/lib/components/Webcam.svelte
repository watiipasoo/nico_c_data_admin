    ...
    <div class="grid lg:flex gap-8 justify-center">
        ...
        <div class="flex lg:hidden gap-4 justify-center">
            ...
            <div class="card p-4 variant-ghost-primary">
                ...
                <button class="rounded-lg variant-filled-tertiary text-white px-4 py-2 btn-lg" on:click={toggleCamera}><Icon icon="solar:camera-rotate-bold" /></button>
                <button class="rounded-lg variant-filled-tertiary text-white px-4 py-2 btn-lg" on:click={downloadImage}><Icon icon="material-symbols-light:download" /></button>
            <button class="rounded-lg variant-filled-secondary text-white px-4 py-2 btn-lg" on:click={capturePhoto}><Icon icon="solar:camera-linear" /></button>
        <button class="rounded-lg variant-filled-warning text-white px-4 py-2 btn-lg" on:click={stopStream}><Icon icon="ant-design:stop-filled" /></button>
            </div>
            </div>
        </div>  
